...
tgacChannel.DelayProfile = 'Model-A';                   % I will select this value myself in final evaluation ---> Delay profile model
...
tgacChannel.TransmitReceiveDistance = 20;               % I will select this value myself in final evaluation ---> Distance in meters for NLOS
